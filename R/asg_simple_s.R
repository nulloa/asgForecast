...
#' @param sd sd of the response model
#' @param group groups of response
#' @param season seasons of response
...
asg_simple_s <- function(y, x, sd, group, season, priors, niter=4000, nwarmup=niter/2, nchains=3, thin=1, inits=NULL){
  # Load Library
  require(rstan)
  ...
  m <- stan(file = system.file("model", "asgSimpleS.stan", package = "asgForecast"), 
